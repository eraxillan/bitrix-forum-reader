...
static void* malloc_wrapper(void* unused, size_t size) { UNUSED_ARG(unused); return malloc(size); }

static void free_wrapper(void* unused, void* ptr) { UNUSED_ARG(unused); free(ptr); }
